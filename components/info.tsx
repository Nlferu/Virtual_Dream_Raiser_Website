export default function Info() {
    return (
        <section id="home" className="mt-[13rem] z-50 scroll-mt-[100rem] max-w-[45rem] mx-[1rem] text-center leading-8">
            <h1 className="text-4xl font-bold capitalize mb-8 text-center text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">
